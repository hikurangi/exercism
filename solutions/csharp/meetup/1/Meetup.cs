...
public class Meetup
{
    ...
    public Meetup(int month, int year)
    {
        _month = month;
        _year = year;
        _teenthRange = Enumerable.Range(13, 19).Select(day => new DateTime(_year, _month, day));
        _monthRange = Enumerable.Range(1, DateTime.DaysInMonth(_year, _month)).Select(day => new DateTime(_year, _month, day));
    }
