...
static class SavingsAccount
{
  ...
  private static int YearsBeforeDesiredBalance(decimal balance, decimal targetBalance, int yearsElapsed) => (AnnualBalanceUpdate(balance) >= targetBalance) ? yearsElapsed : YearsBeforeDesiredBalance(AnnualBalanceUpdate(balance), targetBalance, yearsElapsed + 1);
