...
let hasPassed appointmentDate = (DateTime.Now, appointmentDate) |> DateTime.Compare > 0
...
let description (appointmentDate: DateTime) = 
  $"""You have an appointment on %s{appointmentDate.ToString("M/d/yyyy h:mm:ss tt")}."""
